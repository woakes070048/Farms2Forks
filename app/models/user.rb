class User < ActiveRecord::Base
  ...
  # 1st Farm photo
  has_attached_file :xphoto, :styles => { :medium => "300x300>", :thumb => "100x100#" }, :default_url => "/images/:style/missing.png"
  validates_attachment_content_type :xphoto, :content_type => /\Aimage\/.*\Z/

  # 2nd Farm photo
  has_attached_file :yphoto, :styles => { :medium => "300x300>", :thumb => "100x100#" }, :default_url => "/images/:style/missing.png"
